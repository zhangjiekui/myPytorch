...
def train():
    ...
    for epoch in range(epochs):
        ...
        for i, data in enumerate(trainloader, 0):
            ...
            print('epoch=', epoch + 1, ' i=', i + 1, ' loss=', loss.item(), ' inputs.shape=', inputs.shape,
                  ' labels.shape=', labels.shape, ' trained imgs=', (i + 1) * bs)
            # print statistics
...
def main():
    ...
    testimgs, testlabels = torch.autograd.Variable(testimgs, volatile=True), torch.autograd.Variable(testlabels,
                                                                                                     volatile=True)
